...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  late bool _isLogged;
  CameraPosition _cameraPosition = const CameraPosition(target: LatLng(45.51563, -122.677443),
  zoom: 17
  );
...
if(Get.find<LocationController>().addressList.isNotEmpty){
  ...
  if(Get.find<LocationController>().getUserAddressFromlocalStroage()==""){
...
_addressController.text = Get.find<LocationController>().getUserAddress().address;
        ...
        return GetBuilder<LocationController>(builder: (locationController){
          ...
          print("adresimiz "+ _addressController.text);
          // print(locationController.getAddressFromGeocode(_addressController.text));
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: BigText(text: "Teslimat Adresi"),
                ),
                SizedBox(height: Dimensions.height10/2,),
                AppTextField(textEditingController: _addressController, hintText: "Adresiniz", icon: Icons.location_on_outlined),
                SizedBox(height: Dimensions.height10/2,),
                Padding(
                  padding: EdgeInsets.only(left: Dimensions.width20),
                  child: BigText(text: "Adınız"),
                ),
                SizedBox(height: Dimensions.height10/2,),
                AppTextField(textEditingController: _contactPersonName, hintText: "Adınız", icon: Icons.person),
                SizedBox(height: Dimensions.height10/2,),
                Padding(
                  padding: EdgeInsets.only(left: Dimensions.width20),
                  child: BigText(text: "İletişim numaranız"),
                ),
                SizedBox(height: Dimensions.height10,),
                AppTextField(textEditingController: _contactPersonNumber, hintText: "Telofon numaranız", icon: Icons.phone_enabled_outlined),
                    ...
                    onTap: (){
                     ...
                     locationController.addAddress(_addressModel).then((response){
                      if(response.isSuccess){
                        ...
                        Get.snackbar("başarılı", "Değişiklikler kaydedildi", backgroundColor: Colors.transparent);
                      } else{

                        Get.snackbar("hata", "kayıt başarısız",backgroundColor: Colors.red);
                      }
                     });
                    },
                    child: Container(
                      ...
                      child: BigText(text: "KAYDET",color: Colors.white),
                      decoration: BoxDecoration(

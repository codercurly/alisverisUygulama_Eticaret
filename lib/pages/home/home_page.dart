...
setState(() {
 ...
 @override
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.archive_sharp),label: "arşiv"),
  ...
  /*List<Widget> _buildScreens() {
    return [
      MainFoodPage(),
      Container(child: Center(child: Text("nex"),),),
      Container(child: Center(child: Text("nextt"),),),
      Container(child: Center(child: Text("nextttttttt"),),)
    ];
  }
